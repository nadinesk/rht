  ...
  render() {
    ...
    return (
      ...
      <div >
         ...
         <div onClick={this.handleClick} id="realdonaldtrump">test</div>

           
         <h3>{this.state.selCast}</h3>
         <ul>
          <li style={{display: this.state.selCast == '' ? 'none' : 'block', fontWeight: this.state.displayType == 'detail' ? 'bold' : 'normal' }} onClick={this.handleViewClick}>Monthly</li>
          <li style={{display: this.state.selCast == '' ? 'none' : 'block', fontWeight: this.state.displayType == 'summary' ? 'bold' : 'normal' }} onClick={this.handleViewClick}>Summary</li>
         </ul>
